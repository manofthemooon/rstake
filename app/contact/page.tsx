  ...
  return (
    <div className="bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
      ...
      <div className="container flex items-center justify-center min-h-screen px-4 mx-auto">
        <div className="grid w-full grid-cols-1 gap-4 mx-auto mt-20 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          {socials.map((s) => (
            <Card key={s.label} className="h-40"> 
              <Link
                href={s.href}
                target="_blank"
                className="p-4 relative flex flex-col items-center gap-2 duration-700 group md:gap-4 md:py-10 lg:pb-20 md:p-8" // Уменьшение отступов
              >
                <span
