...
const AboutPage: React.FC = () => {
  ...
  return (
    <div ref={pageRef} className="about-snap-container overflow-hidden relative">
      ...
      <div className="flex flex-col md:flex-row justify-between h-screen p-8">
        <div className="about-snap-block flex flex-col justify-between w-full md:w-1/2">
        ...
        <div className="about-snap-block flex flex-col justify-between w-full md:w-1/2">
          ...
          <div className="skills-info text-left text-white mt-12">
            <h3 className="text-2xl font-bold glow-text">Community organising</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <strong>Holding events online, AMAs, etc.</strong>
              </li>
              <li>
                <strong>Moderating, setting up chats and roles</strong>
              </li>
              <li>
                <strong>Helping new members</strong>
              </li>
            </ul>
          </div>
        </div>
